...
public class MainActivity extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue.add(new JsonObjectRequest(Request.Method.GET, "https://sites.google.com/site/kopperkowsilverrush/files/test.json?attredirects=0&d=1", null, this, this));
    }
